...
const body = [
  '# Font Generators',
  '',
  '> Font Generators is a free collection of browser-based tools for copy-and-paste Unicode text, ASCII banners, real typeface previews, meme captions, and downloadable title artwork. Each generator keeps its existing canonical URL and explains the exact output it produces.',
  '',
  ...
  '- Visual, meme, and theme generators render artwork for PNG or SVG download; their canvas result is not copy-and-paste text.',
