      ...
      <div className="grid items-start gap-7 p-5 sm:p-8 xl:grid-cols-[340px_minmax(0,1fr)]">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl border border-lime-200 bg-lime-50 p-4 text-xs leading-5 text-lime-950 dark:border-lime-900/60 dark:bg-lime-950/30 dark:text-lime-200"><strong>Game Text:</strong> uses an original 5×7 bitmap alphabet drawn directly onto the pixel grid. Each input line stays on one line and scales down to fit; only a manual line break creates another line.</div>
